...
<html lang="en">
	<head>
		...
		<![endif]-->
                ...
                function poponload(){
                    testwindow = window.open("new-address.php", "mywindow", "location=1,status=1,scrollbars=1,width=800,height=1000");
                ...
                <div class="col-md-12">
                    <nav>
                        <ul class="sf-menu">
                            ...
                            <li class="<?php if(isset($body) && $body === 'index-1') {echo ' current';} ?>"><a style="text-decoration: none;" href="#">About Us</a>
                                <ul>
                                    <li><a href="about.php">About Us</a></li>
                                    <li><a href="code-of-ethics.php">Code of Ethics</a></li>
                                    <li><a href="testimonials.php">Testimonials</a></li>
                                    <li><a href="news.php">News</a></li>
                                    <li><a href="senior-life-events.php">Senior Life Events</a></li>
                                </ul>
                            </li>
                            <li class="<?php if(isset($body) && $body === 'index-2') {echo ' current';} ?>"><a href="services.php">Services</a></li>
                            <li class="<?php if(isset($body) && $body === 'blog') {echo ' current';} ?>"><a href="index.php?goto=blog">Blog</a></li>
